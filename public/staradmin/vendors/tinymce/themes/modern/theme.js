  ...
  function (DOMUtils, Tools, Delay, Factory, Rect, Toolbar) {
    ...
    var addContextualToolbars = function (editor) {
      ...
      var reposition = function (match, shouldShow) {
        ...
        // Only show the panel on some projects not for example nodeChange since that fires when context menu is opened
        if (shouldShow) {
          panel.show();
        }
...
define(
  ...
  function (Tools, Factory, DOMUtils, FloatPanel, Toolbar, Menubar, ContextToolbars, A11y, SkinLoaded) {
    var render = function (editor, theme, args) {
      ...
      var hide = function () {
        if (panel) {
          // We require two projects as the inline float panel based toolbar does not have autohide=true
          panel.hide();
