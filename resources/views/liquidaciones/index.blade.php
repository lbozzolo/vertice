...
@section('content')
        ...
        <div class="col-lg-4">
            ...
            <div class="card" style="min-height: 245px">
                <div class="card-body">
                    ...
                    <h2>Ver liquidaciones</h2>

                    {!! Form::open(['url' => route('liquidaciones.consultar'), 'method' => 'post']) !!}
    ...
    @if(isset($result_liq))
        @include('liquidaciones.partials.result-liq')
    @endif


    @if(isset($total_liq))
        @include('liquidaciones.partials.total-liq')
    @endif

    @if(isset($result_ibb))
        @include('liquidaciones.partials.result-ibb')
    @endif

    @if(isset($debitos_creditos))
        @include('liquidaciones.partials.debitos-creditos')
    @endif
