...
<div class="card" id="list-images">
    <div class="card-header">
        ...
        <span class="float-right">
            <span id="producto-id" data-producto-id="{!! route('subir.imagen', ['id' => $work->id, 'class' => 'Work']) !!}"></span>
    ...
    <div class="card-body">
        ...
        <div id="croppie-image" style="display: none">
            ...
            <div class="lead text-center">
                ...
                <a href="{{ route('works.edit', $work->id) }}" class="btn btn-light">Cancelar</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    @if($imagen->main == 0)
                        <a href="{{ route('images.main', ['id' => $work->id, 'class' => 'Work', 'imagen' => $imagen->id]) }}" class="btn btn-primary" title="Marcar como principal">Marcar como principal</a>
                    @else
