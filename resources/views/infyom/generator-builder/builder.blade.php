            ...
            <div class="box-body">
                <form id="form">
                    ...
                    <div class="form-group col-md-4">
                        <label for="txtModelName">Nombre del modelo<span class="required">*</span></label>
                        <input type="text" class="form-control" required id="txtModelName" placeholder="Ingrese el nombre">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="drdCommandType">Tipo de comando</label>
                    ...
                    <div class="form-group col-md-4">
                        <label for="txtCustomTblName">Nombre de tabla personalizado</label>
                        <input type="text" class="form-control" id="txtCustomTblName" placeholder="Ingrese nombre de tabla">
                    </div>
                    <div class="form-group col-md-8">
                        <label for="txtModelName">Opciones</label>
                            ...
                            <div class="checkbox chk-align">
                                <label>
                                    <input type="checkbox" class="flat-red" id="chkSave"> <span
                                            class="chk-label-margin">Guardar Schema</span>
                                </label>
                            </div>
                            ...
                            <div class="checkbox chk-align" id="chMigrate">
                                <label>
                                    <input type="checkbox" class="flat-red" id="chkMigrate"> <span
                                            class="chk-label-margin">Migración</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="txtPrefix" placeholder="Ingrese prefijo">
                    </div>

                    <div class="form-group col-md-1">
                        <label for="txtPaginate">Paginado</label>
                    ...
                    <div class="form-group col-md-12" style="margin-top: 7px">
                        <div class="form-control" style="border-color: transparent;padding-left: 0px">
                            <label style="font-size: 18px">Campos</label>
                        </div>
                    </div>
                    ...
                    <div class="form-inline col-md-12" style="padding-top: 10px">
                        <div class="form-group chk-align" style="border-color: transparent;">
                            <button type="button" class="btn btn-success btn-flat btn-green" id="btnAdd"> <i class="fa fa-plus"></i> Campo
                            </button>
                        </div>
                        <div class="form-group chk-align" style="border-color: transparent;">
                            <button type="button" class="btn btn-success btn-flat btn-green" id="btnPrimary"> <i class="fa fa-plus"></i>
                                Primary
                            </button>
                        </div>
                        <div class="form-group chk-align" style="border-color: transparent;">
                            <button type="button" class="btn btn-success btn-flat btn-green" id="btnTimeStamps"> <i class="fa fa-plus"></i>
                                Timestamps
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="form-inline col-md-12" style="padding:15px 15px;text-align: right">
                        <div class="form-group" style="border-color: transparent;padding-left: 10px">
                            <button type="submit" class="btn btn-flat btn-primary btn-blue" id="btnGenerate">Generar
                            </button>
                        </div>
                        <div class="form-group" style="border-color: transparent;padding-left: 10px">
                            <button type="button" class="btn btn-default btn-flat" id="btnReset" data-toggle="modal"
                                    data-target="#confirm-delete"> Limpiar
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">Confirmar Limpiar</h4>
                                </div>

                                <div class="modal-body">
                                    <p style="font-size: 16px">Esto limpiará todos los campos. ¿Desea continuar?</p>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a id="btnModelReset" class="btn btn-flat btn-danger btn-ok" data-dismiss="modal">Sí</a>
                                </div>
                            </div>
                        </div>
                    </div>
