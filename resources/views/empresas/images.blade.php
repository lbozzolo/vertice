...
{!! Form::open(['url' => route('images.save', ['id' => $empresa->id, 'class' => 'Empresa']), 'method' => 'post', 'files' => true]) !!}
    ...
    <ul class="list-inline" style="border: 2px dotted lightgrey; padding: 5px">
        @forelse($empresa->images as $imagen)
...
@foreach($empresa->images as $imagen)
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    @if($imagen->main == 0)
                        <a href="{{ route('images.main', ['id' => $empresa->id, 'class' => 'Empresa', 'imagen' => $imagen->id]) }}" class="btn btn-primary" title="Marcar como principal">Marcar como principal</a>
                    @else
