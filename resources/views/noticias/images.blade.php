...
<div class="card" id="list-images">
    <div class="card-header">
        ...
        <span class="float-right">
            <span id="producto-id" data-producto-id="{!! route('subir.imagen', ['id' => $noticia->id, 'class' => 'Noticia']) !!}"></span>
    ...
    <div class="card-body" style="background-color: #f2f8f9">
        @forelse($noticia->images as $imagen)
    ...
    <div class="card-body">
        ...
        <div id="croppie-image" style="display: none">
            ...
            <div class="lead text-center">
                ...
                <a href="{{ route('noticias.edit', $noticia->id) }}" class="btn btn-light">Cancelar</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    @if($imagen->main == 0)
                        <a href="{{ route('images.main', ['id' => $noticia->id, 'class' => 'Noticia', 'imagen' => $imagen->id]) }}" class="btn btn-primary" title="Marcar como principal">Marcar como principal</a>
                    @else
