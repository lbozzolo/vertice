                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="themesflat-headings style-1 text-center clearfix">
                                            <h2 class="heading font-size-30">EVENTOS</h2>
                                                    ...
                                                    <div class="inner">
                                                        <div class="thumb data-effect-item has-effect-icon w40 offset-v-19 offset-h-49">
                                                            @if($evento->main_image)
                                                                <img src="{{ route('imagenes.ver', $evento->main_image->path) }}" class="img-responsive" alt="{!! $evento->main_image->title !!}" style="margin: 0px auto">
                                                            @endif
                                                            <div class="overlay-effect bg-color-3"></div>
                                                        </div>
                                                        <div class="text-wrap">
                                                            <h5 class="heading"><a href="{!! route('web.eventos.detalle', $evento->id) !!}">{!! $evento->title !!}</a></h5>
                                                            <div class="elm-meta">
                                                                <p>{{ str_limit($evento->body, 300, $end = '...') }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
