                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="themesflat-headings style-1 text-center clearfix">
                                            <h2 class="heading">RIZOMA GROUP </h2>
                                            ...
                                            <p class="sub-heading">Somos una empresa que suma mas de 20 años de experiencia en la creación de imagen, identidad, diseño, organización de ferias, congresos, jornadas a campo, eventos, diseño y construcción de stands y espacios interactivos.</p>
                                        </div>
                                            ...
                                            <div class="content-list">
                                                <div class="themesflat-list has-icon style-1 icon-left clearfix">
                                                    <div class="inner">
                                                            <span class="item">
                                                                ...
                                                                <span class="text">Creatividad y experiencia</span>
                                                            </span>
                                                    </div>
                                                </div><!-- /.themeslat-list -->
                                                <div class="themesflat-list has-icon style-1 icon-left clearfix">
                                                    <div class="inner">
                                                            <span class="item">
                                                                <span class="icon"><i class="fa fa-check-square"></i></span>
                                                                <span class="text">Soluciones creativas</span>
                                                            </span>
                                                    </div>
                                                </div><!-- /.themeslat-list -->
                                                <div class="themesflat-list has-icon style-1 icon-left clearfix">
                                                    <div class="inner">
                                                            <span class="item">
                                                                <span class="icon"><i class="fa fa-check-square"></i></span>
                                                                <span class="text">Suma de ideas</span>
                                                            </span>
                                                    </div>
                                                </div><!-- /.themeslat-list -->
                                                <div class="themesflat-list has-icon style-1 icon-left clearfix">
                                                ...
                                                <div class="themesflat-list has-icon style-1 icon-left clearfix">
                                                    <div class="inner">
                                                            <span class="item">
                                                                <span class="icon"><i class="fa fa-check-square"></i></span>
                                                                <span class="text">Compromiso</span>
                                                            </span>
                                                    </div>
                                                </div><!-- /.themeslat-list -->
                                                <div class="themesflat-list has-icon style-1 icon-left clearfix">
                                                    <div class="inner">
                                                            <span class="item">
                                                                <span class="icon"><i class="fa fa-check-square"></i></span>
                                                                <span class="text">Actividades de alto impacto</span>
                                                            </span>
                                                    </div>
                                                </div><!-- /.themeslat-list -->
                                            </div><!-- /.content-list -->
                                                ...
                                                <div class="counter-item">
                                                    <div class="inner">
                                                        <div class="text-wrap">
                                                            ...
                                                            <h3 class="heading margin-right-18">PROJECTOS</h3>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="counter-item">
                                                    <div class="inner">
                                                        <div class="text-wrap">
                                                            ...
                                                            <h3 class="heading margin-right-6">EVENTOS</h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- /.themesflat-counter -->
                                                ...
                                                <div class="counter-item">
                                                    <div class="inner">
                                                        <div class="text-wrap">
                                                            ...
                                                            <h3 class="heading margin-right-8">CLIENTES</h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- /.themesflat-counter -->
                                                ...
                                                <div class="counter-item">
                                                    <div class="inner">
                                                        <div class="text-wrap">
                                                            ...
                                                            <h3 class="heading margin-right-10">PRODUCTOS</h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- /.themesflat-counter -->
