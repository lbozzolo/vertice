        ...
        <div class="container margin_60_35">
            ...
            <div class="owl-carousel owl-theme case_studies add_bottom_30">
                ...
                @forelse($productos as $producto)
                    ...
                    <div>
                        <a href="{{ route('web.producto.detalle', $producto->id) }}" title="{!! $producto->name !!}" style="background-color:white">
                            <figure>
                            ...
                            <h4 style="color:grey">{!! $producto->name !!}</h4>
                        </a>
                    </div>

                @empty

                    {{--Productos de muestra por default--}}
