                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="themesflat-headings style-1 text-center clearfix">
                                            <h2 class="heading font-size-30">PROYECTOS</h2>
                                                    ...
                                                    <div class="inner">
                                                        <div class="thumb data-effect-item has-effect-icon w40 offset-v-19 offset-h-49">
                                                            @if($proyecto->main_image)
                                                                <img src="{{ route('imagenes.ver', $proyecto->main_image->path) }}" class="img-responsive" alt="{!! $proyecto->main_image->title !!}" style="margin: 0px auto">
                                                            @endif
                                                            <div class="overlay-effect bg-color-3"></div>
                                                        </div>
                                                        <div class="text-wrap">
                                                            <h5 class="heading"><a href="{!! route('web.proyectos.detalle', $proyecto->id) !!}">{!! $proyecto->title !!}</a></h5>
                                                            <div class="elm-meta">
                                                                <p>{{ str_limit($proyecto->body, 300, $end = '...') }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
